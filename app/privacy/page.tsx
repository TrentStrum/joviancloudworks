					...
					<Card className="p-6 space-y-6">
						<section>
							...
							<p className="text-muted-foreground">
								We collect minimal personal information necessary to provide our services. This
								includes email addresses for authentication and basic usage analytics to improve our
								platform.
							</p>
						</section>
						...
						<section>
							...
							<p className="text-muted-foreground">
								Your information is used solely for providing and improving our services. We never
								sell or share your personal data with third parties without your explicit consent.
							</p>
						</section>
