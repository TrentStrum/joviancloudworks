					...
					<section>
						...
						<Card className="p-6">
							<p className="text-lg text-muted-foreground">
								Senior Cloud Solutions Architect with over a decade of experience in designing and
								implementing scalable cloud infrastructure. Passionate about leveraging cutting-edge
