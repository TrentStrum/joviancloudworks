		...
		<HeroHighlight>
			<div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
				<div className="px-8">
					...
					>
						Our newest, most amazing app yet{' '}
						<Highlight className="text-black dark:text-white">Webulae!</Highlight>
...
export const SkeletonTwo = () => {
	...
	// Use useEffect to apply random rotations after mount
			...
			<div className="flex flex-row -ml-20">
				{images.map((image, idx) => (
					<motion.div
						...
						style={{
							rotate: rotations[idx] || 0, // Default to 0 before client-side calculation
						}}
