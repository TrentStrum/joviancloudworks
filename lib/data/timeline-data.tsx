		...
		content: (
			<Card className="p-6">
				...
				<p className="text-muted-foreground">
					Led the development of enterprise-scale cloud infrastructure solutions, resulting in 40%
					cost reduction and 99.99% uptime for critical systems.
				</p>
			</Card>
		),
	},
	...
	},
	{
		...
		content: (
			<Card className="p-6">
				...
				<p className="text-muted-foreground">
					Established CI/CD pipelines and automated deployment processes, reducing deployment time
					by 75% and improving reliability.
				</p>
			</Card>
		),
	},
